        ...
        <nav className="headerS__nav">
          ...
          <li>
            <ul className="headerS__item">
              <li>
                <Link to="/Catalog" onClick={() => changeCategory("novelties")}>
                  НОВИНИКИ
                </Link>
              </li>
              <li>
                <Link to="/Catalog" onClick={() => changeCategory("tops and vests")}>
                  КАТЕГОРИИ
                </Link>
              </li>
              <li>
                <Link to="/Catalog" onClick={() => changeCategory("Autumn-winter 20-21")}>
                  НАШИ КОЛЛЕКЦИИ
                </Link>
              </li>
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M3.87742 23.5611L0.972656 25.189V25.528H20.3814L21.3256 19.04L21.167 19.0219L17.1719 24.7654H7.64119V12.8184H13.0307L15.1684 16.1713H15.4731V8.79389H15.1684L13.0307 12.0558H7.64119V0.762617H15.9539L19.0231 6.48798H19.1875V0H0.972656V0.33902L3.87742 1.98531V23.5611Z"
                      fill="black"
                    />
                  </svg>
                </Link>
