    ...
    <header className="header">
      <div className="container">
        ...
        <nav className="header__nav-bottom">
          ...
          <li>
            <Link to="Brand" className="header__nav-bottom_link" href="#">
              О БРЕНДЕ
            </Link>
          </li>
          <li>
            <Link to="showRoom" className="header__nav-bottom_link" href="#">
              ШОУРУМ
            </Link>
          </li>
          <li>
            <Link to="Contact" className="header__nav-bottom_link" href="#">
              КОНТАКТЫ
            </Link>
          </li>
        </nav>
