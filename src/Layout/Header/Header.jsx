      ...
      <div className="container">
        <nav className="header__nav">
          ...
          <li className="header__nav-logo">
            ...
            <h4 className="header__nav-logo_title">
              ЖЕНСКИЙ <br />
              СМОКИНГ
            </h4>
          </li>
        ...
        <nav className="header__nav-bottom">
          ...
          <li>
            <Link to="Brand" className="header__nav-bottom_link">
              О БРЕНДЕ
            </Link>
          </li>
          <li>
            <Link to="showRoom" className="header__nav-bottom_link">
              ШОУРУМ
            </Link>
          </li>
          <li>
            <Link to="Contact" className="header__nav-bottom_link">
              КОНТАКТЫ
            </Link>
          </li>
        </nav>
