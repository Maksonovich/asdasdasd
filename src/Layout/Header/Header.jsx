        ...
        <nav className='header__nav'>
          <li>
            <ul className='header__nav-icon'>
              ...
              <li>
                <a href="#">
                  <svg className='burger-Menu' width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path clip-rule="evenodd" d="M13.8469 5.52449C13.0808 5.52449 12.4492 4.88871 12.4492 4.11594C12.4492 3.31937 13.0808 2.68359 13.8469 2.68359C14.6138 2.68359 15.2454 3.31937 15.2454 4.11594C15.2454 4.88871 14.6138 5.52449 13.8469 5.52449Z" fill="#2F2F2F" />
                  </svg>
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#">
                  <svg width="8" height="17" viewBox="0 0 8 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path clip-rule="evenodd" d="M5.28495 16.1219H1.82511V8.22679H0.113281V5.515H1.82511V3.88404C1.82511 1.65199 2.79595 0.330078 5.56704 0.330078H7.86153V3.05967H6.4318C5.35567 3.05967 5.28495 3.43666 5.28495 4.14131V5.51419H7.88002L7.57944 8.22679H5.28495V16.1219Z" fill="#2F2F2F" />
                  </svg>
                </a>
              </li>
            </ul>
            ...
            <ul className='header__nav-num'>
              ...
              <li className='header__nav-num-icon'>
                <Link to="Favorite">
                  ...
                  <p className='header__nav-count'></p>
                </Link>
