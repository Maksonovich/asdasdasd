            ...
            <div className="Making__blocks-left">
              <form action="/djkama">
                ...
                <div className="Making__blocks-left_inputs">
                  <div className="Making__blocks-left_inputs-title">
                    Основная информация
                  </div>
                  ...
                  <div className="Making__blocks-left_inputs-item">
                    <input type="number" placeholder="Введите телефон" required/>
                  </div>
                  <div className="Making__blocks-left_inputs-item">
                ...
                <div className="Making__blocks-left_bold">
                ...
                <label className="Making__blocks-left_label">
                  ...
                  <b></b>
                  <span>
                    Я принимаю <a>договор публичной оферты</a>
                  </span>
                </label>
                <button className="Making__blocks-left_btn" type="submit">
                  Оформить заказ
                </button>
              </form>
            </div>
