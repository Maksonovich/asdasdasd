...
import eleanBg from "../../assets/Primerka/backPrimerka.jpg";
            ...
            <div className="top">
              ...
              <div>
                ...
                <p>
                  ...
                  <br /> бренда, подобрать желанный образ и получить
                  индивидуальные
                  <br /> рекомендации.Примерка может занимать до 2-х часов.
                </p>
                <br />
                <p>
                  — Также можно заказать доставку с возможностью примерки перед
                  <br /> покупкой, в течение 15-ти минут.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  <br /> картой любого банка, без комиссии.
                </p>
                <br />
                <p>
                  — Можно сделать доставку с возможностью примерки в течение
                  15-ти <br /> минут, об этом нужно сообщить менеджеру при
                  подтверждении <br /> заказа. Если изделие Вам не подходит, Вы
                  можете сразу же его <br /> отдать курьеру. Затем связаться с
                  нами по телефону 8 495 150 14 <br /> 77, чтобы оформить обмен
                  или возврат. Подробнее здесь (ссылка на <br /> страницу обмен
                  и возврат)
                </p>
              </div>
            </div>
              ...
              <div className="reviews_block">
                ...
                <div className="reviews_row">
                  <div className="reviews_video">
                    <ReactPlayer
                      className="reviews"
                      url="https://youtu.be/Z7O1TldAeVg"
                    />
                  </div>
                  <div className="reviews_video">
                    <ReactPlayer
