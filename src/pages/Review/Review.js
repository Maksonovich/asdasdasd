    ...
    <>
      ...
      <section className="Otziv">
        <div className="container">
              ...
              <div className="Otziv_inner_l_content">
                ...
                <div className="Otziv_inner_l_coment">
                  <div className="Otziv_inner_l_coment_p">
                    <p>
                      Ирина <span> г. Москва</span>{" "}
                    </p>
                    <p>26 Марта 2017</p>
                  </div>
                  <div className="Otziv_inner_l_coment_text">
                    <p>
                      Да, доставка заграницу осуществляется курьерской службой
                      до двери. Доставка заграницу оплачивается при оформлении
          ...
          <div className="Otziv_button" onClick={() => isOpen(!open)}>{`${
            open ? "ЗАКРЫТЬ" : "СМОТРЕТЬ ВСЕ"
          }`}</div>
        </div>
      </section>
    </>
